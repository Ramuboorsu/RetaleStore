...
<ul class="nav navbar-nav navbar-top">
         <a href="index1.php" id="name" class="navbar-brand" style='margin:0px 10px;'><b >Cadra Retail store</b></a>
         <a href="bookings.php" id="name1" class="navbar-brand" style='margin:0px 10px;'><b >Cadra Booking</b></a>
</ul>
...
$product_query = "SELECT * FROM products LIMIT $start,$limit";
  ...
  if(mysqli_num_rows($run_query) > 0){
    ...
    <div class='slide' id='$pro_cat'>
      <a href=index1.php?id=$pro_cat><img src='product_images/$pro_image'/ style='width: 100%; 
...
$product_query = "SELECT * FROM products LIMIT $start,$limit";
  ...
  if(mysqli_num_rows($run_query) > 0){
    ...
    <div class='slide' id='$pro_id'>
      <a ><img src='product_images/$pro_image'/ style='width: 100%; 
    height: 282px; margin:0px 20px;'  ></a>
    </div>" ;
