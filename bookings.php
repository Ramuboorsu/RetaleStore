...

{
	...
	document.getElementById("getbookings").style.display = "none";

$("#list").hover(function(){

document.getElementById("getbookings").style.display = "block";
...
$("#getbookings").mouseleave(function()
{
document.getElementById("getbookings").style.display = "none";
})
});
...
<div class="navbar navbar-inverse navbar-fixed-top" >
		...
		<div class="collapse navbar-collapse" id="collapse" >
          ...
          <div id="getbookings" style="text-align:center;margin-top:10px;margin-left:-100px;display:none;background-color:brown; ">
				</div>
        </a></li>
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" ><span class="glyphicon glyphicon-shopping-cart" style="font-size:18px;color:red;"></span>&nbsp;&nbsp;Bookings<sup><span class="bookings">0</span></sup></a>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-offset-3" style="margin:0px 160px;">
				...
				<div class="panel panel-info" style="width:1450px;margin-left:-120px;margin-top:40px;">
