	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-2 col-xs-12">
				<div id="get_category" style="margin-left:-120px; ">
				</div>
				...
				<div id="get_brand" style="margin-left:-120px; ">
				</div>
				<!--<div class="nav nav-pills nav-stacked">
			...
			<div class="col-md-8 col-xs-12">
				...
				<div class="panel panel-info" style="width:1200px;margin-left:-120px;">
